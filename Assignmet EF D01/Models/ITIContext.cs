...
public partial class ITIContext : DbContext
{
    ...
    public virtual DbSet<Lasttrn> Lasttrns { get; set; }
    ...
    public virtual DbSet<dailytrn> dailytrns { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=HABEEEEBA\\SQLEXPRESS;Initial Catalog=ITI;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Instructor>(entity =>
        {
            ...
            entity.Property(e => e.Ins_Degree)
                .IsRequired()
                .HasMaxLength(50);
        ...
        modelBuilder.Entity<Lasttrn>(entity =>
        {
            entity.HasKey(e => e.UserID).HasName("PK__Lasttrns__1788CCAC45F365D3");
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.HasOne(d => d.Dept).WithMany(p => p.Students)
                .HasForeignKey(d => d.Dept_Id)
                .HasConstraintName("FK_Student_Department1");
        ...
        modelBuilder.Entity<dailytrn>(entity =>
        {
            entity.HasKey(e => e.UserID).HasName("PK__dailytrn__1788CCAC4222D4EF");
